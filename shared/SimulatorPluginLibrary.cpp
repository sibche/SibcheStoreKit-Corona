...
#include "SimulatorPluginSibcheStoreKit.h"
...
CORONA_EXPORT int CoronaPluginLuaLoad_simulator_plugin_SibcheStoreKit( lua_State * );

// ----------------------------------------------------------------------------

CORONA_EXPORT
int luaopen_plugin_SibcheStoreKit( lua_State *L )
{
	using namespace Corona;

	lua_CFunction factory = Corona::Lua::Open< CoronaPluginLuaLoad_simulator_plugin_SibcheStoreKit >;
